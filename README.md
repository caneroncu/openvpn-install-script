...
1. First, visit this link to get %20 discount and get the cheapest plan https://yolla.link/hosting (in order to get the discount you need to visit this link before making a purchase)
2. Click on **Services** (the top menu) -> **VPS Hosting** then click on **"Choose Plan"** button and select **KVM 1** plan and complete the purchase.
